...
public:
    ...
    [[nodiscard]] point_cycle& operator= (const point_cycle& other) {
    ...
    [[nodiscard]] inline point_distance_type weight() const {
        return weight(this->_cycle);
    }
    ...
    inline void invert(uint32_t i, uint32_t j) {
